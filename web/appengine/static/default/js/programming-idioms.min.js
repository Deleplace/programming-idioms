...
;hljs.registerLanguage("smalltalk",e)})();(()=>{var V=Object.defineProperty;var s=(m,v)=>V(m,"name",{value:v,configurable:!0});$(function(){var m=s(function(e){var t=new Date(e),a=t.getDate(),i=t.getMonth()+1,o=t.getFullYear();return""+o+"-"+(i<=9?"0"+i:i)+"-"+(a<=9?"0"+a:a)},"YYYYMMDD"),v=s(function(e){var t=new Date(e),a=t.getHours(),i=t.getMinutes();return""+(a<=9?"0"+a:a)+":"+(i<=9?"0"+i:i)},"HHmm"),A=s(function(e){return m(e)+" "+v(e)},"YYYYMMDDHHmm");$("button").button(),$(".sortable-lang").sortable({update:function(e,t){w()}}),$(".implementations-tabs").tabs({activate:function(e,t){$("pre[data-content]").popover("show")}}),$(".togglabe").on("click",function(){$(this).toggleClass("active")}),$("div[data-content]").popover({html:!0}).popover("show"),$("textarea[data-content]").popover({html:!0,trigger:"manual"}).popover("show"),$("pre[data-content]").popover({html:!0}).popover("show"),$(document).on("click",".popover-content",function(){let e=$(this).closest(".picode").children("pre");e.length==1&&$(this).closest(".popover").hide("slide",{direction:"left"},200,function(){e.popover("toggle")})}),$("input[data-content]").popover({trigger:"manual"}).popover("show"),$("button.show-popover").popover("show"),$(".popover-on-hover").popover({trigger:"hover focus"}),$(".idiom-picture img").on("load",function(){$("pre[data-content]").popover("show")}),$(window).on("resize",function(){$("pre[data-content]").popover("show")}),$(".input-suggest-language").typeahead({source:function(e,t){return $.get("/typeahead-languages",{userInput:e},function(a){return a.options=a.options||[],t(a.options)})},matcher:function(e){return!0},updater:function(e){I(e)}}),$(".language-single-select .typeahead").typeahead({source:function(e,t){return $.get("/typeahead-languages",{userInput:e},function(a){let i={};return a&&a.options&&(i=t(a.options)),i})},matcher:function(e){return!0}}),$.fn.clearMessages=function(){$(".message-zone .pimessage").html("")},$.fn.pisuccess=function(e){$.fn.clearMessages(),$(".message-zone .alert-success").html(e)},$.fn.pierror=function(e){$.fn.clearMessages(),$(".message-zone .alert-error").html(e)},$.fn.piinfo=function(e){$.fn.clearMessages(),$(".message-zone .alert-info").html(e)},$(".ajax-generic-action").on("click",function(){if(!($(this).hasClass("confirm-needed")&&!window.confirm("Are you sure?"))){var e={};if($(this).hasClass("reason-needed")){var t=window.prompt("Why?");if(t===null)return;e={reason:t}}var a=$(this).attr("data-url");$.ajax({url:a,type:"POST",data:e,xhr:function(){var i=$.ajaxSettings.xhr();return i},success:function(i){$.fn.pisuccess("OK!! "+JSON.stringify(i))},error:function(i,o,n){$.fn.pierror(i.responseText)}})}});var g=s(function(){var e=$.cookie("Nickname");return!!e},"logged"),x=s(function(){return $.cookie("Nickname")},"username");$("#modal-nickname .form-nickname").on("submit",function(){var e=$(this).find("input.nickname").val();e.length>30&&(e=e.substring(0,30)),$.cookie("Nickname",e,{expires:100,path:"/"}),$(".greetings").html('<i class="fas fa-user"> '+e+'</i> <a href="#" class="remove-nickname fas fa-times" alt="Clear username" title="Clear username"></a>').show(),$("#modal-nickname").modal("hide")}),$(document).on("click",".remove-nickname",function(){d("remove-nickname"),$.removeCookie("Nickname",{path:"/"}),$(".greetings").hide()}),$(".user-info-link a").on("click",function(){var e='<div class="modal-header">	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>	<h3>Cookie contents</h3></div>',t=$(e),a=$("<div>").addClass("modal-body"),i=$("<dl>");if(g()){var o=$("<dt><tt>Nickname</tt></dt>"),n=$("<button>").text("Delete this cookie");o.append(n);var r=$("<dd>").text(x());n.on("click",function(){d("cookie-box/delete-cookie-nickname"),$.removeCookie("Nickname",{path:"/"}),i.hide("slow",function(){i.remove()}),u.hide("slow",function(){u.remove()}),_(),$("p.greetings").hide("slow",function(){$("p.greetings").remove()})}),i.append(o).append(r),a.append(i)}var l=$("<dl>"),c=$.cookie("my-languages");if(c){var p=$("<dt><tt>my-languages</tt></dt>"),n=$("<button>").text("Delete this cookie");n.on("click",function(){d("cookie-box/delete-cookie-favlangs"),$.removeCookie("my-languages",{path:"/"}),l.hide("slow",function(){l.remove()}),_(),$("ul.favorite-languages li").hide("slow",function(){$("ul.favorite-languages li").remove()})}),p.append(n),l.append(p);var f=c.split(/_/);f.forEach(function(b){var D=$("<dd>").text(b);l.append(D)}),a.append(l)}var u=$("<div>").addClass("profile-take-away");u.append("<h4>To take your profile with you</h4>"),u.append("<p>Copy this URL. Profiles are not stored on server, only in cookies or in this URL.</p>"),urlbox=$("<input>").attr("type","text").addClass("profile-url"),u.append(urlbox);let h=$('<a href="#" class="copy-url-clipboard"><i class="far fa-copy" title="Copy to the clipboard"></i></a>');h.on("click",function(){d("cookie-box/copy-profile-url"),navigator.clipboard.writeText(urlbox.val()).then(function(){console.log("Copying to clipboard was successful!"),h.html('<i class="fas fa-clipboard-check" title="The profile link has been copied to clipboard"></i>')},function(L){alert("Async: Could not copy text: "+L)})}),u.append(h),a.append(u);var C=location.protocol+"//"+location.hostname+(location.port?":"+location.port:""),_=s(function(){var L=x(),b=$.cookie("my-languages");b||(b="");var D=C+"/my/"+encodeURIComponent(L)+"/_"+b;urlbox.val(D)},"updateProfileUrl");return _(),$("<div>").addClass("modal").addClass("profile-box").append(t).append(a).modal("show"),urlbox.select(),!1}),$(".idiom_cover .count").on("click",function(){$(this).children("i").toggleClass("icon-chevron-right icon-chevron-down"),$(this).parent().children(".full").toggle()}),$(".voting-idiom").on("click",function(){if(!g()){$("#modal-nickname").modal({keyboard:!0});return}$.ajaxSetup({error:function(r,l,c){$.fn.pierror("Error: "+c)}});var e=this,t=$(e);t.button("loading");var a=$(this).parent().next();a.removeClass("hidden");var i=a.children("i"),o=$(this).attr("data-idiom-id"),n=$(this).attr("data-vote-choice");$.get("/ajax-idiom-vote",{idiomId:o,choice:n},function(r){var l=r.rating,c=r.myVote;i.html(" "+l),t.button("reset"),$.fn.updateVoteButtonsActiveState(t.parent(),c)})}),$(".voting-impl").on("click",function(){if(!g()){$("#modal-nickname").modal();return}$.ajaxSetup({error:function(n,r,l){$.fn.pierror("Error: "+l)}});var e=$(this);e.button("loading");var t=$(this).parent().next();t.removeClass("hidden");var a=t.children("i"),i=$(this).attr("data-impl-id"),o=$(this).attr("data-vote-choice");$.get("/ajax-impl-vote",{implId:i,choice:o},function(n){var r=n.rating,l=n.myVote;a.html(" "+r),e.button("reset"),$.fn.updateVoteButtonsActiveState(e.parent(),l)})}),$.fn.updateVoteButtonsActiveState=function(e,t){t==1?e.children("[data-vote-choice='up']").addClass("active"):e.children("[data-vote-choice='up']").removeClass("active"),t==-1?e.children("[data-vote-choice='down']").addClass("active"):e.children("[data-vote-choice='down']").removeClass("active")};function I(e){let t=R(e);e=y(e);var a=$(`
			<li class="active" data-language="${e}">
				...
				</li>`),a.appendTo($(".right_column .cheatsheet-links ul")),w()}s(I,"addFavlang");var w=s(function(){var e=$(".favorite-languages")[0],t="";$(e).children().each(function(a,i){var o=$(i).attr("data-language");o&&(t+=o+"_")}),$.cookie("my-languages",t,{expires:100,path:"/"}),t==""&&$.cookie("see-non-favorite","1",{expires:100,path:"/"})},"updateFavlangCookie");$(document).on("click",".show-languages-pool",function(){$(".addible-languages-pool").show(200)}),$(document).on("click",".addible-languages-pool button",function(){var a=$(this).parent(),e=a.attr("data-language"),t=$(this).html(),a=$('<li class="active" data-language="'+e+'"><span class="badge badge-success">'+t+' <a href="#" class="favorite-language-remove fas fa-times" title="Remove fav"></a></span></li>');a.hide().appendTo($(".favorite-languages")).show("normal"),d("fav-lang-bar-add/"+e),w(),$(this).hide("normal"),$(".btn-see-non-favorite").show().removeClass("disabled")}),$(document).on("click",".favorite-language-remove",function(){var e=$(this),t=e.parent();e.remove();var a=t.html(),i=t.parent(),o=i.attr("data-language");d("fav-lang-bar-remove/"+o),i.removeAttr("data-language"),i.slideUp(500,function(){i.remove()}),w();var n=$('<li data-language="'+o+'"><button class="btn btn-primary btn-mini active togglabe">'+a+"</button></li>");n.hide().prependTo($(".addible-languages-pool ul")).show("normal")}),$(".btn-see-non-favorite").on("click",function(){oldValue=$(this).hasClass("active"),oldValue?($.cookie("see-non-favorite","0",{expires:100,path:"/"}),d("see-non-favorite/set/0")):($.cookie("see-non-favorite","1",{expires:100,path:"/"}),d("see-non-favorite/set/1")),location.reload()}),$(document).on("click",".selector-language",function(){var e=$(this).closest("li").attr("data-language"),t=R(e);return $(this).closest(".language-single-select").find("input[type=text]").val(t).change(),!1});function P(){return/\/diff\//.test(window.location.pathname)?!1:/^\/idiom\//.test(window.location.pathname)}s(P,"isIdiomPage");function S(){return/\/diff\//.test(window.location.pathname)?!1:/\/idiom\/[0-9]+\/[^/]+\/[0-9]+\/[^/]+/.test(window.location.pathname)}s(S,"isIdiomDetailWithLang");function j(){let e=window.location.pathname.split(/\//),t=e[e.length-1];return t=z(t),t}if(s(j,"extractLangFromURL"),S()){let e=j();Y(e)||I(e)}$(".implementations-tabs li:first-child").addClass("active"),$(".implementations-tabs li").on("click",function(){$(this).parent().children("li").removeClass("active"),$(this).addClass("active")});function F(){var e=$(this).closest(".idiom-summary-large").attr("data-idiom-id");d("grid/"+e),$(".modal-impl-grid").modal()}s(F,"showImplGrid"),$(".show-impl-grid").on("click",function(){F.call(this)}),$(".copy-imports-to-clipboard a").on("click",function(){var e=$(this),t=e.closest(".implementation"),a=t.find(".piimports"),i=a.find("pre").text();return i?(d("impl/copy-imports-to-clipboard/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang")),navigator.clipboard.writeText(i).then(function(){console.log("Copying imports to clipboard was successful!"),e.html('<i class="fas fa-clipboard-check" title="The imports code has been copied to clipboard"></i>'),$(".just-copied-to-clipboard").removeClass("just-copied-to-clipboard"),a.addClass("just-copied-to-clipboard")},function(o){alert("Async: Could not copy imports text: "+o)}),!1):(alert("Sorry, failed to retrieve the imports code :("),!1)}),$("a.copy-code-to-clipboard").on("click",function(){var e=$(this),t=e.closest(".implementation");return T(e,t),d("impl/copy-to-clipboard/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang")),!1});function T(e,t){var a=t.find(".picode"),i=a.find("pre").text();if(!i)return alert("Sorry, failed to retrieve the snippet code :("),!1;navigator.clipboard.writeText(i).then(function(){console.log("Copying to clipboard was successful!"),e.html('<i class="fas fa-clipboard-check" title="The snippet code has been copied to clipboard"></i>'),$(".just-copied-to-clipboard").removeClass("just-copied-to-clipboard"),t.addClass("just-copied-to-clipboard")},function(o){alert("Async: Could not copy text: "+o)})}s(T,"clipboardCopyCodeOfImpl"),$(".impl-external-links .demo a").on("click",function(e){var t=$(this).closest(".implementation");d("impl/demo/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang"))}),$(".impl-external-links .doc a").on("click",function(e){var t=$(this).closest(".implementation");d("impl/doc/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang"))}),$(".impl-external-links .origin a").on("click",function(e){var t=$(this).closest(".implementation");d("impl/origin/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang"))}),$(".form-idiom-creation .language-choices a, .form-impl-creation .language-choices a").on("click",function(){var e=$(this).closest(".form-idiom-creation, .form-impl-creation");newLang=e.find("input[name=impl_language]").attr("value"),$.get("/ajax-demo-site-suggest",{lang:newLang},function(t){t.suggestion&&e.find("input[name=impl_demo_url]").attr("placeholder",t.suggestion)})}),$("input[name=impl_language]").on("change",function(){let e=$(this),t=e.val(),a=t.toLowerCase(),i=e.closest(".control-group");if(i.length==0)return;let o=i.find(".help-inline");if(t===""){i.removeClass("error"),o.text("");return}$.get("/supported-languages",{},function(n){window.setTimeout(()=>{t=e.val(),a=t.toLowerCase(),n.languages&&(n.languages.find(function(r){return r.toLowerCase()===a})?(console.debug(`${t} is a legit lang, clearing any error`),i.removeClass("error"),o.text("")):(console.warn(t+" is currently not a supported language"),i.addClass("error"),o.text(t+" is currently not a supported language. Supported languages are "+n.languages.join(", ")),i.find(".language-single-select").popover("hide")))},200)})}),$("textarea[name=impl_code").on("change",function(){let e=$(".warning-code-cromulence");e.hide().empty();function t(o){e.append($("<div>").html(o)).show()}s(t,"warn");let a=$(this).val(),i=$(this).attr("data-variables");if(i){i=i.replace(/[_ ]/g,"");let o=i.split(","),n=[];for(let r=0;r<o.length;r++)new RegExp("\\b"+o[r].toLowerCase()+"\\b").test(a.toLowerCase())||n.push(o[r]);if(n.length>=1){let r=n.length>=2?"s":"",l=n.map(function(p){return"<em>"+p+"</em>"}),c="The code <i>should</i> contain the identifier"+r+" "+l.join(", ")+".";t(c)}}/\bmain\b/.test(a)&&t("Are you sure about <em>main</em>? We usually don't want a whole program.")}),$("textarea").on("keydown",function(e){if(e.keyCode===9&&!e.ctrlKey){var t=this.selectionStart,a=this.selectionEnd,i=$(this),o=i.val();i.val(o.substring(0,t)+"	"+o.substring(a)),this.selectionStart=this.selectionEnd=t+1,e.preventDefault()}}),$(document).on("click",".btn-flag-impl",function(e){let t=$(e.target).closest(".btn-flag-impl"),a;do if(a=window.prompt("I'd like to report this implementation because:"),a===null)return;while(a==="");let i=t.attr("data-idiom-id"),o=t.attr("data-impl-id"),n=t.attr("data-idiom-version");$.post("/ajax-impl-flag/"+i+"/"+o,{idiomVersion:n,rationale:a}).done(function(){alert("Thanks :)")}).fail(function(){alert("Unfortunately we could not save this report :(")})});function k(e){var t=e.replace(/\b_([\w$]*)/gm,"<em>$1</em>");return t=t.replace(/\n/g,"<br/>"),t}s(k,"emphasize");function N(){$("pre[data-content]").popover("hide");var e=$(".modal-impl-preview"),t=$(".form-impl-creation input[name=impl_language]").val();e.find(".lang-tab span.label").html(t);var a=$(".form-impl-creation textarea.imports").val();a?e.find(".piimports pre > code").text(a).show():e.find(".piimports pre > code").text(a).hide(),e.find(".picode pre > code").text($(".form-impl-creation textarea.impl-code").val());var i=$(".form-impl-creation textarea[name=impl_comment]").val(),o=$("<div>").text(i).html(),n=k(o);e.find(".picode pre").attr("data-content",n);var r=$(".form-impl-creation input[name=impl_doc_url]").val();r?e.find("a.impl-doc").attr("href",r).show():e.find("a.impl-doc").attr("href","#").hide();var l=$(".form-impl-creation input[name=impl_demo_url]").val();l?e.find("a.impl-demo").attr("href",l).show():e.find("a.impl-demo").attr("href","#").hide();var c=$(".form-impl-creation input[name=impl_attribution_url]").val();c?e.find("a.impl-attribution").attr("href",c).show():e.find("a.impl-attribution").attr("href","#").hide(),e.modal(),window.setTimeout(function(){$("pre[data-content]").popover("show")},800)}s(N,"showImplCreatePreview"),$(".btn-impl-create-preview").on("click",function(){return N(),!1});function B(){$("pre[data-content]").popover("hide");var e=$(".modal-impl-preview"),t=$(".form-impl .badge").html();e.find(".lang-tab span.label").html(t);var a=$(".form-impl textarea.imports").val();a?e.find(".piimports pre > code").text(a).show():e.find(".piimports pre > code").text(a).hide(),e.find(".picode pre > code").text($(".form-impl textarea.impl-code").val());var i=$(".form-impl textarea[name=impl_comment]").val(),o=$("<div>").text(i).html(),n=k(o);e.find(".picode pre").attr("data-content",n);var r=$(".form-impl input[name=impl_doc_url]").val();r?e.find("a.impl-doc").attr("href",r).show():e.find("a.impl-doc").attr("href","#").hide();var l=$(".form-impl input[name=impl_demo_url]").val();l?e.find("a.impl-demo").attr("href",l).show():e.find("a.impl-demo").attr("href","#").hide();var c=$(".form-impl input[name=impl_attribution_url]").val();c?e.find("a.impl-attribution").attr("href",c).show():e.find("a.impl-attribution").attr("href","#").hide(),e.modal(),window.setTimeout(function(){$("pre[data-content]").popover("show")},800)}s(B,"showImplEditPreview"),$(".btn-impl-edit-preview").on("click",function(){return B(),!1});function E(){$("pre[data-content]").popover("hide");var e=$(".modal-idiom-preview"),t=$(".form-idiom-creation input[name=idiom_title]").val();e.find(".idiom-title").html(t);var a=$(".form-idiom-creation textarea[name=idiom_lead]").val(),i=$("<div>").text(a).html(),o=k(i);e.find(".idiom-lead-paragraph").html(o);var n=$(".form-idiom-creation input[name=impl_language]").val();e.find(".lang-tab span.label").html(n);var r=$(".form-idiom-creation textarea.imports").val();r?e.find(".piimports pre > code").text(r).show():e.find(".piimports pre > code").text(r).hide(),e.find(".picode pre > code").text($(".form-idiom-creation textarea.impl-code").val());var l=$(".form-idiom-creation textarea[name=impl_comment]").val(),c=$("<div>").text(l).html(),p=k(c);e.find(".picode pre").attr("data-content",p);var f=$(".form-idiom-creation input[name=impl_doc_url]").val();f?e.find("a.impl-doc").attr("href",f).show():e.find("a.impl-doc").attr("href","#").hide();var u=$(".form-idiom-creation input[name=impl_demo_url]").val();u?e.find("a.impl-demo").attr("href",u).show():e.find("a.impl-demo").attr("href","#").hide();var h=$(".form-idiom-creation input[name=impl_attribution_url]").val();h?e.find("a.impl-attribution").attr("href",h).show():e.find("a.impl-attribution").attr("href","#").hide(),e.modal(),window.setTimeout(function(){$("pre[data-content]").popover("show")},800)}s(E,"showIdiomCreatePreview"),$(".btn-idiom-create-preview").on("click",function(){return E(),!1}),setTimeout(function(){g()&&$.get("/ajax-user-message-box",function(e){var t=e.messages;if(t.length>0){var a=$(".user-messages");t.forEach(function(i){var o=$("<div>").addClass("user-message alert");o.append($("<div>").addClass("dismissal").html($("<button>").attr("type","button").addClass("close").html("&times; dismiss").attr("key",i.key).on("click",function(r){console.log("Dismissing "+$(this).attr("key"));var l=$(this);$.ajax({url:"/ajax-dismiss-user-message",type:"POST",data:{key:l.attr("key")},xhr:function(){var c=$.ajaxSettings.xhr();return c},success:function(c){console.log("User message dismissed."),l.closest(".user-message").hide("fast")},error:function(c,p,f){$.fn.pierror(c.responseText)}})}))),o.append($("<h4>").html("Message for "+x())),o.append($("<div>").addClass("date").append($("<small>").html(A(i.creationDate))));var n=i.message.replace(/\n/g,"<br/>");o.append($("<div>").addClass("content").html(n)),a.append(o)}),a.show("fast")}})},300);function M(e){$(e).each(function(){$("<img/>")[0].src=this})}s(M,"preload"),$("img.dice").each(function(){var e=$(this).attr("src");if(e.indexOf("_highlight")===-1){var t=e.replace(".png","_highlight.png").replace(".svg","_highlight.svg");M([t])}}),$(document).on("submit","form.two-languages-select",function(){var e=$(this).find("input[name=lang1]").val(),t=$(this).find("input[name=lang2]").val();return e=y(e),t=y(t),window.location.href="/cheatsheet/"+e+"/"+t,!1}),$("form.idiom-restore-version > input.presubmit").on("click",function(e){var t=$(this).closest("form"),a="";t.find("input[name=why]").val()&&(a=t.find("input[name=why]").val());var i=window.prompt("Why?",a);i!==null&&(t.find("input[name=why]").val(i),t.submit())});function O(e){let t=j(),a=document.title,i=$(".idiom-lead-paragraph").text();i||(i=a);let o=e.CreationDate.substring(0,10),n=e.Author,r=[];e.Implementations.forEach(function(p){if(p.LanguageName.toLowerCase()!=t.toLowerCase())return;let f=window.location.href.split(/\//),u=f.length;f[u-2]=p.Id;let h=f.join("/"),C={"@type":"Answer",text:p.CodeBlock,dateCreated:p.CreationDate.substring(0,10),url:h,author:{"@type":"Person",name:p.Author}};r.push(C)});let l=document.createElement("script");l.setAttribute("type","application/ld+json");let c={"@context":"https://schema.org","@type":"QAPage",mainEntity:{"@type":"Question",name:a,text:i,answerCount:r.length,dateCreated:o,author:{"@type":"Person",name:n},license:"https://en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License",suggestedAnswer:r}};l.textContent=JSON.stringify(c,null,"  "),document.head.appendChild(l),console.debug("Generated Q&A structured data")}if(s(O,"generateQAStructuredData"),S()){let e=$(".idiom-summary-large").attr("data-idiom-id");fetch("/api/idiom/"+e).then(function(t){return t.json()}).then(function(t){O(t)})}$(".dice").on("click",function(){$(this).addClass("spinning-jolty")}),$(".implementations-tabs ul.nav.nav-tabs.language-names").each(function(){let e=$(this);/[\S]/.test(e.html())||(console.debug("Hiding empty nav-tabs"),e.hide())});function U(){$("<div>").addClass("modal").attr("tabindex","-1").addClass("keyboard-shortcuts").append(`<div class="modal-header">
			...
			</div>`).modal("show")}if(s(U,"showKeyboardShortcuts"),P()){let e=$(".idiom-summary-large").attr("data-idiom-id"),t=$("div.implementation").first(),a=t.attr("data-impl-id"),i=t.attr("data-impl-lang"),o=t.find("a.copy-code-to-clipboard");$(document).on("keydown",function(p){if(!(p.target.tagName.toLowerCase()==="input"||p.target.tagName.toLowerCase()==="textarea")&&!(p.ctrlKey||p.altKey||p.metaKey))switch(p.key){case"?":d("keyboard/show-keyboard-shortcuts"),U();break;case"r":d("keyboard/random-idiom"),window.location="/random-idiom";break;case"/":d("keyboard/search"),$("form.form-search > input[name=q]").first().focus(),p.preventDefault();break;case"p":d("keyboard/previous-idiom"),window.location=`/previous-idiom/${e}`;break;case"n":d("keyboard/next-idiom"),window.location=`/next-idiom/${e}`;break;case"e":d(`keyboard/impl-edit/${e}/${a}`),window.location=`/impl-edit/${e}/${a}`;break;case"c":d(`keyboard/impl/copy-to-clipboard/${e}/${a}/${i}`),T(o,t);break;case"d":let f=t.find("li.demo > a").attr("href");f&&(d(`keyboard/impl/demo/${e}/${a}/${i}`),window.open(f,"_blank"));break;case"i":let u=t.find("li.doc > a").attr("href");u&&(d(`keyboard/impl/doc/${e}/${a}/${i}`),window.open(u,"_blank"));break;case"x":d(`keyboard/impl-create/${e}`),window.location=`/impl-create/${e}`;break;case"g":d(`keyboard/grid/${e}`),$(".modal-impl-grid").modal();break;case"h":d(`keyboard/history/${e}`),window.location=`/history/${e}`;break;case"z":i&&(d(`keyboard/cheatsheet/${i}`),window.open(`/cheatsheet/${i}`,"_blank"));break}});let n=o.find("i");n.attr("title",n.attr("title")+" (c)");let r=t.parent().find("a.btn-edit");r.attr("title",r.attr("title")+" (e)");let l=t.find("li.demo > a");l&&l.attr("title","Online demo (d)");let c=t.find("li.doc > a");c&&c.attr("title","Documentation page (i)")}$("a.show-keyboard-shortcuts").click(function(){d("/right/show-keyboard-shortcuts"),U()}),$("form.form-impl.form-edit input[name=impl_doc_url]").change(function(){let e=$(this),t=$("form.form-impl.form-edit input[name=edit_summary]");e.val()&&!t.val()&&t.val("Added Doc URL")}),$("form.form-impl.form-edit input[name=impl_demo_url]").change(function(){let e=$(this),t=$("form.form-impl.form-edit input[name=edit_summary]");e.val()&&!t.val()&&t.val("Added Demo URL")})});function d(m){fetch("/using/"+m,{method:"POST",body:JSON.stringify({page:window.location.pathname+window.location.search})})}s(d,"using");function y(m){switch(m.toLowerCase()){case"c++":return"Cpp";case"c#":return"Csharp";case"cs":return"Csharp";case"golang":return"go";case"py":return"Python";case"rs":return"Rust"}return m}s(y,"normLang");function R(m){switch(m){case"Cpp":return"C++";case"Csharp":return"C#"}return m}s(R,"niceLang");function z(m){return m.charAt(0).toUpperCase()+m.slice(1)}s(z,"capitalizeFirstLetter");function Y(m){m=y(m);let v=$.cookie("my-languages");return v?v.toLowerCase().split("_").indexOf(m.toLowerCase())!==-1:!1}s(Y,"hasFavlangInCookie");})();
