			...
			<li class="active" data-language="${e}">
				<span class="badge badge-success">
					...
					<i class="fas fa-list"></i> <a href="/cheatsheet/${e}">${t}</a>
						...
						</div>`).modal("show");break;case"r":d("keyboard/random-idiom"),window.location="/random-idiom";break;case"/":d("keyboard/search"),$("form.form-search > input[name=q]").first().focus(),c.preventDefault();break;case"p":d("keyboard/previous-idiom"),window.location=`/previous-idiom/${e}`;break;case"n":d("keyboard/next-idiom"),window.location=`/next-idiom/${e}`;break;case"e":d(`keyboard/impl-edit/${e}/${a}`),window.location=`/impl-edit/${e}/${a}`;break;case"c":d(`keyboard/impl/copy-to-clipboard/${e}/${a}/${i}`),j(o,t);break;case"d":let u=t.find("li.demo > a").attr("href");u&&(d(`keyboard/impl/demo/${e}/${a}/${i}`),window.open(u,"_blank"));break;case"i":let m=t.find("li.doc > a").attr("href");m&&(d(`keyboard/impl/doc/${e}/${a}/${i}`),window.open(m,"_blank"));break;case"x":d(`keyboard/impl-create/${e}`),window.location=`/impl-create/${e}`;break;case"g":d(`keyboard/grid/${e}`),$(".modal-impl-grid").modal();break;case"h":window.location=`/history/${e}`;break;case"z":i&&(d(`keyboard/cheatsheet/${i}`),window.location=`/cheatsheet/${i}`);break}});let n=o.find("i");n.attr("title",n.attr("title")+" (c)");let r=t.parent().find("a.btn-edit");r.attr("title",r.attr("title")+" (e)");let l=t.find("li.demo > a");l&&l.attr("title","Online demo (d)");let s=t.find("li.doc > a");s&&s.attr("title","Documentation page (i)")}});function d(p){fetch("/using/"+p,{method:"POST",body:JSON.stringify({page:window.location.pathname+window.location.search})})}function y(p){switch(p.toLowerCase()){case"c++":return"Cpp";case"c#":return"Csharp";case"cs":return"Csharp";case"golang":return"go";case"py":return"Python";case"rs":return"Rust"}return p}function S(p){switch(p){case"Cpp":return"C++";case"Csharp":return"C#"}return p}function M(p){return p.charAt(0).toUpperCase()+p.slice(1)}function O(p){p=y(p);let w=$.cookie("my-languages");return w?w.toLowerCase().split("_").indexOf(p.toLowerCase())!==-1:!1}})();
