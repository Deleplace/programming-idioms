...
(()=>{$(function(){var c=function(e){var t=new Date(e),a=t.getDate(),i=t.getMonth()+1,n=t.getFullYear();return""+n+"-"+(i<=9?"0"+i:i)+"-"+(a<=9?"0"+a:a)},w=function(e){var t=new Date(e),a=t.getHours(),i=t.getMinutes();return""+(a<=9?"0"+a:a)+":"+(i<=9?"0"+i:i)},_=function(e){return c(e)+" "+w(e)};$("button").button(),$(".sortable-lang").sortable({update:function(e,t){b()}}),$(".implementations-tabs").tabs({activate:function(e,t){$("pre[data-content]").popover("show")}}),$(".togglabe").on("click",function(){$(this).toggleClass("active")}),$("div[data-content]").popover({html:!0}).popover("show"),$("textarea[data-content]").popover({html:!0,trigger:"manual"}).popover("show"),$("pre[data-content]").popover({html:!0}).popover("show"),$(document).on("click",".popover-content",function(){let e=$(this).closest(".picode").children("pre");e.length==1&&$(this).closest(".popover").hide("slide",{direction:"left"},200,function(){e.popover("toggle")})}),$("input[data-content]").popover({trigger:"manual"}).popover("show"),$("button.show-popover").popover("show"),$(".popover-on-hover").popover({trigger:"hover focus"}),$(".idiom-picture img").on("load",function(){$("pre[data-content]").popover("show")}),$(window).on("resize",function(){$("pre[data-content]").popover("show")}),$(".input-suggest-language").typeahead({source:function(e,t){return $.get("/typeahead-languages",{userInput:e},function(a){return a.options=a.options||[],t(a.options)})},matcher:function(e){return!0},updater:function(e){L(e)}}),$(".language-single-select .typeahead").typeahead({source:function(e,t){return $.get("/typeahead-languages",{userInput:e},function(a){let i={};return a&&a.options&&(i=t(a.options)),i})},matcher:function(e){return!0}}),$.fn.clearMessages=function(){$(".message-zone .pimessage").html("")},$.fn.pisuccess=function(e){$.fn.clearMessages(),$(".message-zone .alert-success").html(e)},$.fn.pierror=function(e){$.fn.clearMessages(),$(".message-zone .alert-error").html(e)},$.fn.piinfo=function(e){$.fn.clearMessages(),$(".message-zone .alert-info").html(e)},$(".ajax-generic-action").on("click",function(){if(!($(this).hasClass("confirm-needed")&&!window.confirm("Are you sure?"))){var e={};if($(this).hasClass("reason-needed")){var t=window.prompt("Why?");if(t===null)return;e={reason:t}}var a=$(this).attr("data-url");$.ajax({url:a,type:"POST",data:e,xhr:function(){var i=$.ajaxSettings.xhr();return i},success:function(i){$.fn.pisuccess("OK!! "+JSON.stringify(i))},error:function(i,n,o){$.fn.pierror(i.responseText)}})}});var h=function(){var e=$.cookie("Nickname");return!!e},C=function(){return $.cookie("Nickname")};$("#modal-nickname .form-nickname").on("submit",function(){var e=$(this).find("input.nickname").val();e.length>30&&(e=e.substring(0,30)),$.cookie("Nickname",e,{expires:100,path:"/"}),$(".greetings").html('<i class="fas fa-user"> '+e+'</i> <a href="#" class="remove-nickname fas fa-times" alt="Clear username" title="Clear username"></a>').show(),$("#modal-nickname").modal("hide")}),$(document).on("click",".remove-nickname",function(){m("remove-nickname"),$.removeCookie("Nickname",{path:"/"}),$(".greetings").hide()}),$(".user-info-link a").on("click",function(){var e='<div class="modal-header">	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>	<h3>Cookie contents</h3></div>',t=$(e),a=$("<div>").addClass("modal-body"),i=$("<dl>");if(h()){var n=$("<dt><tt>Nickname</tt></dt>"),o=$("<button>").text("Delete this cookie");n.append(o);var r=$("<dd>").text(C());o.on("click",function(){$.removeCookie("Nickname",{path:"/"}),i.hide("slow",function(){i.remove()}),p.hide("slow",function(){p.remove()}),v(),$("p.greetings").hide("slow",function(){$("p.greetings").remove()})}),i.append(n).append(r),a.append(i)}var l=$("<dl>"),s=$.cookie("my-languages");if(s){var d=$("<dt><tt>my-languages</tt></dt>"),o=$("<button>").text("Delete this cookie");o.on("click",function(){$.removeCookie("my-languages",{path:"/"}),l.hide("slow",function(){l.remove()}),v(),$("ul.favorite-languages li").hide("slow",function(){$("ul.favorite-languages li").remove()})}),d.append(o),l.append(d);var u=s.split(/_/);u.forEach(function(g){var y=$("<dd>").text(g);l.append(y)}),a.append(l)}var p=$("<div>").addClass("profile-take-away");p.append("<h4>To take your profile with you</h4>"),p.append("<p>Copy this URL. Profiles are not stored on server, only in cookies or in this URL.</p>"),urlbox=$("<input>").attr("type","text").addClass("profile-url"),p.append(urlbox),a.append(p);var f=location.protocol+"//"+location.hostname+(location.port?":"+location.port:""),v=function(){var N=C(),g=$.cookie("my-languages");g||(g="");var y=f+"/my/"+encodeURIComponent(N)+"/_"+g;urlbox.val(y)};return v(),$("<div>").addClass("modal").addClass("profile-box").append(t).append(a).modal("show"),urlbox.select(),!1}),$(".idiom_cover .count").on("click",function(){$(this).children("i").toggleClass("icon-chevron-right icon-chevron-down"),$(this).parent().children(".full").toggle()}),$(".voting-idiom").on("click",function(){if(!h()){$("#modal-nickname").modal({keyboard:!0});return}$.ajaxSetup({error:function(r,l,s){$.fn.pierror("Error: "+s)}});var e=this,t=$(e);t.button("loading");var a=$(this).parent().next();a.removeClass("hidden");var i=a.children("i"),n=$(this).attr("data-idiom-id"),o=$(this).attr("data-vote-choice");$.get("/ajax-idiom-vote",{idiomId:n,choice:o},function(r){var l=r.rating,s=r.myVote;i.html(" "+l),t.button("reset"),$.fn.updateVoteButtonsActiveState(t.parent(),s)})}),$(".voting-impl").on("click",function(){if(!h()){$("#modal-nickname").modal();return}$.ajaxSetup({error:function(o,r,l){$.fn.pierror("Error: "+l)}});var e=$(this);e.button("loading");var t=$(this).parent().next();t.removeClass("hidden");var a=t.children("i"),i=$(this).attr("data-impl-id"),n=$(this).attr("data-vote-choice");$.get("/ajax-impl-vote",{implId:i,choice:n},function(o){var r=o.rating,l=o.myVote;a.html(" "+r),e.button("reset"),$.fn.updateVoteButtonsActiveState(e.parent(),l)})}),$.fn.updateVoteButtonsActiveState=function(e,t){t==1?e.children("[data-vote-choice='up']").addClass("active"):e.children("[data-vote-choice='up']").removeClass("active"),t==-1?e.children("[data-vote-choice='down']").addClass("active"):e.children("[data-vote-choice='down']").removeClass("active")};function L(e){let t=A(e);e=x(e);var a=$(`
			<li class="active" data-language="${e}">
				...
				</li>`),a.appendTo($(".right_column .cheatsheet-links ul")),b()}var b=function(){var e=$(".favorite-languages")[0],t="";$(e).children().each(function(a,i){var n=$(i).attr("data-language");n&&(t+=n+"_")}),$.cookie("my-languages",t,{expires:100,path:"/"}),t==""&&$.cookie("see-non-favorite","1",{expires:100,path:"/"})};$(document).on("click",".show-languages-pool",function(){$(".addible-languages-pool").show(200)}),$(document).on("click",".addible-languages-pool button",function(){var e=$(this).parent(),t=e.attr("data-language"),a=$(this).html(),e=$('<li class="active" data-language="'+t+'"><span class="badge badge-success">'+a+' <a href="#" class="favorite-language-remove fas fa-times" title="Remove fav"></a></span></li>');e.hide().appendTo($(".favorite-languages")).show("normal"),m("fav-lang-bar-add/"+t),b(),$(this).hide("normal"),$(".btn-see-non-favorite").show().removeClass("disabled")}),$(document).on("click",".favorite-language-remove",function(){var e=$(this),t=e.parent();e.remove();var a=t.html(),i=t.parent(),n=i.attr("data-language");m("fav-lang-bar-remove/"+n),i.removeAttr("data-language"),i.slideUp(500,function(){i.remove()}),b();var o=$('<li data-language="'+n+'"><button class="btn btn-primary btn-mini active togglabe">'+a+"</button></li>");o.hide().prependTo($(".addible-languages-pool ul")).show("normal")}),$(".btn-see-non-favorite").on("click",function(){oldValue=$(this).hasClass("active"),oldValue?($.cookie("see-non-favorite","0",{expires:100,path:"/"}),m("see-non-favorite/set/0")):($.cookie("see-non-favorite","1",{expires:100,path:"/"}),m("see-non-favorite/set/1")),location.reload()}),$(document).on("click",".selector-language",function(){var e=$(this).closest("li").attr("data-language"),t=A(e);return $(this).closest(".language-single-select").find("input[type=text]").val(t).change(),!1});function j(){return/\/diff\//.test(window.location.pathname)?!1:/\/idiom\/[0-9]+\/[^/]+\/[0-9]+\/[^/]+/.test(window.location.pathname)}function D(){let e=window.location.pathname.split(/\//),t=e[e.length-1];return t=E(t),t}if(j()){let e=D();M(e)||L(e)}$(".implementations-tabs li:first-child").addClass("active"),$(".implementations-tabs li").on("click",function(){$(this).parent().children("li").removeClass("active"),$(this).addClass("active")});function S(){var e=$(this).closest(".idiom-summary-large").attr("data-idiom-id");m("grid/"+e),$(".modal-impl-grid").modal()}$(".show-impl-grid").on("click",function(){S.call(this)}),$(".copy-imports-to-clipboard a").on("click",function(){var e=$(this),t=e.closest(".implementation"),a=t.find(".piimports"),i=a.find("pre").text();if(!i){alert("Sorry, failed to retrieve the imports code :(");return}return m("impl/copy-imports-to-clipboard/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang")),navigator.clipboard.writeText(i).then(function(){console.log("Copying imports to clipboard was successful!"),e.html('<i class="fas fa-clipboard-check" title="The imports code has been copied to clipboard"></i>'),$(".just-copied-to-clipboard").removeClass("just-copied-to-clipboard"),a.addClass("just-copied-to-clipboard")},function(n){alert("Async: Could not copy imports text: "+n)}),!1}),$("a.copy-code-to-clipboard").on("click",function(){var e=$(this),t=e.closest(".implementation"),a=t.find(".picode"),i=a.find("pre").text();if(!i){alert("Sorry, failed to retrieve the snippet code :(");return}return m("impl/copy-to-clipboard/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang")),navigator.clipboard.writeText(i).then(function(){console.log("Copying to clipboard was successful!"),e.html('<i class="fas fa-clipboard-check" title="The snippet code has been copied to clipboard"></i>'),$(".just-copied-to-clipboard").removeClass("just-copied-to-clipboard"),t.addClass("just-copied-to-clipboard")},function(n){alert("Async: Could not copy text: "+n)}),!1}),$(".impl-external-links .demo a").on("click",function(e){var t=$(this).closest(".implementation");m("impl/demo/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang"))}),$(".impl-external-links .doc a").on("click",function(e){var t=$(this).closest(".implementation");m("impl/doc/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang"))}),$(".impl-external-links .origin a").on("click",function(e){var t=$(this).closest(".implementation");m("impl/origin/"+t.attr("data-idiom-id")+"/"+t.attr("data-impl-id")+"/"+t.attr("data-impl-lang"))}),$(".form-idiom-creation .language-choices a, .form-impl-creation .language-choices a").on("click",function(){var e=$(this).closest(".form-idiom-creation, .form-impl-creation");newLang=e.find("input[name=impl_language]").attr("value"),$.get("/ajax-demo-site-suggest",{lang:newLang},function(t){t.suggestion&&e.find("input[name=impl_demo_url]").attr("placeholder",t.suggestion)})}),$("input[name=impl_language]").on("autocompletechange",function(e,t){alert("autocompletechange")}),$("input[name=impl_language]").on("change",function(){let e=$(this),t=e.val(),a=t.toLowerCase(),i=e.closest(".control-group");if(i.length==0)return;let n=i.find(".help-inline");if(t===""){i.removeClass("error"),n.text("");return}$.get("/supported-languages",{},function(o){window.setTimeout(()=>{t=e.val(),a=t.toLowerCase(),o.languages&&(o.languages.find(function(r){return r.toLowerCase()===a})?(console.debug(`${t} is a legit lang, clearing any error`),i.removeClass("error"),n.text("")):(console.warn(t+" is currently not a supported language"),i.addClass("error"),n.text(t+" is currently not a supported language. Supported languages are "+o.languages.join(", ")),i.find(".language-single-select").popover("hide")))},200)})}),$("textarea[name=impl_code").on("change",function(){let e=$(".warning-code-cromulence");e.hide().empty();function t(n){e.append($("<div>").html(n)).show()}let a=$(this).val(),i=$(this).attr("data-variables");if(i){i=i.replace(/[_ ]/g,"");let n=i.split(","),o=[];for(let r=0;r<n.length;r++)new RegExp("\\b"+n[r].toLowerCase()+"\\b").test(a.toLowerCase())||o.push(n[r]);if(o.length>=1){let r=o.length>=2?"s":"",l=o.map(function(d){return'<span class="variable">'+d+"</span>"}),s="The code <i>should</i> contain the identifier"+r+" "+l.join(", ")+".";t(s)}}/\bmain\b/.test(a)&&t(`Are you sure about <span class="variable">main</span>? We usually don't want a whole program.`)}),$("textarea").on("keydown",function(e){if(e.keyCode===9&&!e.ctrlKey){var t=this.selectionStart,a=this.selectionEnd,i=$(this),n=i.val();i.val(n.substring(0,t)+"	"+n.substring(a)),this.selectionStart=this.selectionEnd=t+1,e.preventDefault()}}),$(document).on("click",".btn-flag-impl",function(e){let t=$(e.target).closest(".btn-flag-impl"),a;do if(a=window.prompt("I'd like to report this implementation because:"),a===null)return;while(a==="");let i=t.attr("data-idiom-id"),n=t.attr("data-impl-id"),o=t.attr("data-idiom-version");$.post("/ajax-impl-flag/"+i+"/"+n,{idiomVersion:o,rationale:a}).done(function(){alert("Thanks :)")}).fail(function(){alert("Unfortunately we could not save this report :(")})});function k(e){var t=e.replace(/\b_([\w$]*)/gm,'<span class="variable">$1</span>');return t=t.replace(/\n/g,"<br/>"),t}function T(){$("pre[data-content]").popover("hide");var e=$(".modal-impl-preview"),t=$(".form-impl-creation input[name=impl_language]").val();e.find(".lang-tab span.label").html(t);var a=$(".form-impl-creation textarea.imports").val();a?e.find(".piimports pre").text(a).show():e.find(".piimports pre").text(a).hide(),e.find(".picode pre").text($(".form-impl-creation textarea.impl-code").val());var i=$(".form-impl-creation textarea[name=impl_comment]").val(),n=$("<div>").text(i).html(),o=k(n);e.find(".picode pre").attr("data-content",o);var r=$(".form-impl-creation input[name=impl_doc_url]").val();r?e.find("a.impl-doc").attr("href",r).show():e.find("a.impl-doc").attr("href","#").hide();var l=$(".form-impl-creation input[name=impl_demo_url]").val();l?e.find("a.impl-demo").attr("href",l).show():e.find("a.impl-demo").attr("href","#").hide();var s=$(".form-impl-creation input[name=impl_attribution_url]").val();s?e.find("a.impl-attribution").attr("href",s).show():e.find("a.impl-attribution").attr("href","#").hide(),e.modal(),window.setTimeout(function(){$("pre[data-content]").popover("show")},800)}$(".btn-impl-create-preview").on("click",function(){return T(),!1});function I(){$("pre[data-content]").popover("hide");var e=$(".modal-impl-preview"),t=$(".form-impl .badge").html();e.find(".lang-tab span.label").html(t);var a=$(".form-impl textarea.imports").val();a?e.find(".piimports pre").text(a).show():e.find(".piimports pre").text(a).hide(),e.find(".picode pre").text($(".form-impl textarea.impl-code").val());var i=$(".form-impl textarea[name=impl_comment]").val(),n=$("<div>").text(i).html(),o=k(n);e.find(".picode pre").attr("data-content",o);var r=$(".form-impl input[name=impl_doc_url]").val();r?e.find("a.impl-doc").attr("href",r).show():e.find("a.impl-doc").attr("href","#").hide();var l=$(".form-impl input[name=impl_demo_url]").val();l?e.find("a.impl-demo").attr("href",l).show():e.find("a.impl-demo").attr("href","#").hide();var s=$(".form-impl input[name=impl_attribution_url]").val();s?e.find("a.impl-attribution").attr("href",s).show():e.find("a.impl-attribution").attr("href","#").hide(),e.modal(),window.setTimeout(function(){$("pre[data-content]").popover("show")},800)}$(".btn-impl-edit-preview").on("click",function(){return I(),!1});function U(){$("pre[data-content]").popover("hide");var e=$(".modal-idiom-preview"),t=$(".form-idiom-creation input[name=idiom_title]").val();e.find(".idiom-title").html(t);var a=$(".form-idiom-creation textarea[name=idiom_lead]").val(),i=$("<div>").text(a).html(),n=k(i);e.find(".idiom-lead-paragraph").html(n);var o=$(".form-idiom-creation input[name=impl_language]").val();e.find(".lang-tab span.label").html(o);var r=$(".form-idiom-creation textarea.imports").val();r?e.find(".piimports pre").text(r).show():e.find(".piimports pre").text(r).hide(),e.find(".picode pre").text($(".form-idiom-creation textarea.impl-code").val());var l=$(".form-idiom-creation textarea[name=impl_comment]").val(),s=$("<div>").text(l).html(),d=k(s);e.find(".picode pre").attr("data-content",d);var u=$(".form-idiom-creation input[name=impl_doc_url]").val();u?e.find("a.impl-doc").attr("href",u).show():e.find("a.impl-doc").attr("href","#").hide();var p=$(".form-idiom-creation input[name=impl_demo_url]").val();p?e.find("a.impl-demo").attr("href",p).show():e.find("a.impl-demo").attr("href","#").hide();var f=$(".form-idiom-creation input[name=impl_attribution_url]").val();f?e.find("a.impl-attribution").attr("href",f).show():e.find("a.impl-attribution").attr("href","#").hide(),e.modal(),window.setTimeout(function(){$("pre[data-content]").popover("show")},800)}$(".btn-idiom-create-preview").on("click",function(){return U(),!1}),setTimeout(function(){h()&&$.get("/ajax-user-message-box",function(e){var t=e.messages;if(t.length>0){var a=$(".user-messages");t.forEach(function(i){var n=$("<div>").addClass("user-message alert");n.append($("<div>").addClass("dismissal").html($("<button>").attr("type","button").addClass("close").html("&times; dismiss").attr("key",i.key).on("click",function(r){console.log("Dismissing "+$(this).attr("key"));var l=$(this);$.ajax({url:"/ajax-dismiss-user-message",type:"POST",data:{key:l.attr("key")},xhr:function(){var s=$.ajaxSettings.xhr();return s},success:function(s){console.log("User message dismissed."),l.closest(".user-message").hide("fast")},error:function(s,d,u){$.fn.pierror(s.responseText)}})}))),n.append($("<h4>").html("Message for "+C())),n.append($("<div>").addClass("date").append($("<small>").html(_(i.creationDate))));var o=i.message.replace(/\n/g,"<br/>");n.append($("<div>").addClass("content").html(o)),a.append(n)}),a.show("fast")}})},300);function R(e){$(e).each(function(){$("<img/>")[0].src=this})}$("img.dice").each(function(){var e=$(this).attr("src");if(e.indexOf("_highlight")===-1){var t=e.replace(".png","_highlight.png").replace(".svg","_highlight.svg");R([t])}}),$(document).on("submit","form.two-languages-select",function(){var e=$(this).find("input[name=lang1]").val(),t=$(this).find("input[name=lang2]").val();return e=x(e),t=x(t),window.location.href="/cheatsheet/"+e+"/"+t,!1}),$("form.idiom-restore-version > input.presubmit").on("click",function(e){var t=$(this).closest("form"),a="";t.find("input[name=why]").val()&&(a=t.find("input[name=why]").val());var i=window.prompt("Why?",a);i!==null&&(t.find("input[name=why]").val(i),t.submit())});function P(e){let t=D(),a=document.title,i=$(".idiom-lead-paragraph").text();i||(i=a);let n=e.CreationDate.substring(0,10),o=e.Author,r=[];e.Implementations.forEach(function(d){if(d.LanguageName.toLowerCase()!=t.toLowerCase())return;let u=window.location.href.split(/\//),p=u.length;u[p-2]=d.Id;let f=u.join("/"),v={"@type":"Answer",text:d.CodeBlock,dateCreated:d.CreationDate.substring(0,10),url:f,author:{"@type":"Person",name:d.Author}};r.push(v)});let l=document.createElement("script");l.setAttribute("type","application/ld+json");let s={"@context":"https://schema.org","@type":"QAPage",mainEntity:{"@type":"Question",name:a,text:i,answerCount:r.length,dateCreated:n,author:{"@type":"Person",name:o},license:"https://en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License",suggestedAnswer:r}};l.textContent=JSON.stringify(s,null,"  "),document.head.appendChild(l),console.debug("Generated Q&A structured data")}if(j()){let e=$(".idiom-summary-large").attr("data-idiom-id");fetch("/api/idiom/"+e).then(function(t){return t.json()}).then(function(t){P(t)})}$(".dice").on("click",function(){$(this).addClass("spinning-jolty")}),$(".implementations-tabs ul.nav.nav-tabs.language-names").each(function(){let e=$(this);/[\S]/.test(e.html())||(console.debug("Hiding empty nav-tabs"),e.hide())})});function m(c){fetch("/using/"+c,{method:"POST",body:JSON.stringify({page:window.location.pathname+window.location.search})})}function x(c){switch(c.toLowerCase()){case"c++":return"Cpp";case"c#":return"Csharp";case"cs":return"Csharp";case"golang":return"go";case"py":return"Python";case"rs":return"Rust"}return c}function A(c){switch(c){case"Cpp":return"C++";case"Csharp":return"C#"}return c}function E(c){return c.charAt(0).toUpperCase()+c.slice(1)}function M(c){c=x(c);let w=$.cookie("my-languages");return w?w.toLowerCase().split("_").indexOf(c.toLowerCase())!==-1:!1}})();
